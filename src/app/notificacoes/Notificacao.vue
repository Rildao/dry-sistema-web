        ...
        <Fieldset>
            ...
            <div class="flex flex-column md:flex-row gap-4">
                ...
                <div class="md:w-9 xl:w-10 xl:p-3">
                    <DataTable v-model:selection="notificacaoSelecionada" paginator :rows="5" :rowsPerPageOptions="[5, 10, 15]" :value="novasSelecionada ? notificacoes : notificacoesVistas" dataKey="id" tableStyle="min-width: 50rem">
